...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([favoriteType isEqualToString:@"articles"]) {
        ...
        WiFiArticleListCell *cell = [[[NSBundle mainBundle] loadNibNamed:@"WiFiArticleListCell" 
...
-(void) tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([favoriteType isEqualToString:@"articles"]) {
        ...
        WiFiArticleDetailViewController *articleDetailViewController=[[WiFiArticleDetailViewController alloc] 
                                                                      initWithArticleContent:currentArticle.articleContent 
                                                                      articleTitle:currentArticle.articleTitle 
                                                                      articleUrl:currentArticle.articleUrl 
                                                                      articleImageUrl:currentArticle.articleImageUrl];
